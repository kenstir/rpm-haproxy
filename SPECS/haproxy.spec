...
%endif
USE_TFO=1
%{__make} %{?_smp_mflags} CPU="generic" TARGET="linux2628" ${systemd_opts} ${pcre_opts} USE_OPENSSL=1 USE_ZLIB=1 ${regparm_opts} ADDINC="%{optflags}" USE_LINUX_TPROXY=1 USE_THREAD=1 USE_TFO=1 EXTRA_OBJS="contrib/prometheus-exporter/service-prometheus.o" ADDLIB="%{__global_ldflags}"
